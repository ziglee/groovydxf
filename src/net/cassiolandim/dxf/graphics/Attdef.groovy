...
class Attdef extends GraphicEntity {

    private static final String ATTDEF_TPL = """  0
ATTDEF
  5
0
  8
...
"""
    ...
    Attdef(ClassifiedTags tags, Drawing drawing = null) {
        super(tags, drawing)
    }

    Attdef(String handle, Map dxfAttribs, Drawing drawing) {
        super(handle, dxfAttribs, drawing)
    }

    @Override
    ClassifiedTags getTemplate() {
        return ClassifiedTags.fromText(ATTDEF_TPL)
    }
